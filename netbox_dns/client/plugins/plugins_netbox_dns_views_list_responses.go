...
func (o *PluginsNetboxDNSViewsListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPluginsNetboxDNSViewsListOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewPluginsNetboxDNSViewsListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPluginsNetboxDNSViewsListOK() *PluginsNetboxDNSViewsListOK {
	return &PluginsNetboxDNSViewsListOK{}
}
...
func (o *PluginsNetboxDNSViewsListOK) Error() string {
	return fmt.Sprintf("[GET /plugins/netbox-dns/views/][%d] pluginsNetboxDnsViewsListOK  %+v", 200, o.Payload)
}
...
func (o *PluginsNetboxDNSViewsListOK) GetPayload() *PluginsNetboxDNSViewsListOKBody {
	return o.Payload
}

func (o *PluginsNetboxDNSViewsListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(PluginsNetboxDNSViewsListOKBody)
...
func NewPluginsNetboxDNSViewsListDefault(code int) *PluginsNetboxDNSViewsListDefault {
	return &PluginsNetboxDNSViewsListDefault{
		_statusCode: code,
	}
}
...
func (o *PluginsNetboxDNSViewsListDefault) Code() int {
	return o._statusCode
}

func (o *PluginsNetboxDNSViewsListDefault) Error() string {
	return fmt.Sprintf("[GET /plugins/netbox-dns/views/][%d] plugins_netbox-dns_views_list default  %+v", o._statusCode, o.Payload)
}

func (o *PluginsNetboxDNSViewsListDefault) String() string {
	return fmt.Sprintf("[GET /plugins/netbox-dns/views/][%d] plugins_netbox-dns_views_list default  %+v", o._statusCode, o.Payload)
}
...
func (o *PluginsNetboxDNSViewsListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*
PluginsNetboxDNSViewsListOKBody plugins netbox DNS views list o k body
swagger:model PluginsNetboxDNSViewsListOKBody
*/
...
func (o *PluginsNetboxDNSViewsListOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PluginsNetboxDNSViewsListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("pluginsNetboxDnsViewsListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *PluginsNetboxDNSViewsListOKBody) validateNext(formats strfmt.Registry) error {
	if swag.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("pluginsNetboxDnsViewsListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *PluginsNetboxDNSViewsListOKBody) validatePrevious(formats strfmt.Registry) error {
	if swag.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("pluginsNetboxDnsViewsListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *PluginsNetboxDNSViewsListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("pluginsNetboxDnsViewsListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
		...
		if o.Results[i] != nil {
			if err := o.Results[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("pluginsNetboxDnsViewsListOK" + "." + "results" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("pluginsNetboxDnsViewsListOK" + "." + "results" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *PluginsNetboxDNSViewsListOKBody) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
...
func (o *PluginsNetboxDNSViewsListOKBody) UnmarshalBinary(b []byte) error {
	var res PluginsNetboxDNSViewsListOKBody
