...
// NewPluginsNetboxDNSNameserversDeleteParams creates a new PluginsNetboxDNSNameserversDeleteParams object,
...
func NewPluginsNetboxDNSNameserversDeleteParams() *PluginsNetboxDNSNameserversDeleteParams {
	return &PluginsNetboxDNSNameserversDeleteParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNetboxDNSNameserversDeleteParamsWithTimeout creates a new PluginsNetboxDNSNameserversDeleteParams object
...
// NewPluginsNetboxDNSNameserversDeleteParamsWithContext creates a new PluginsNetboxDNSNameserversDeleteParams object
...
// NewPluginsNetboxDNSNameserversDeleteParamsWithHTTPClient creates a new PluginsNetboxDNSNameserversDeleteParams object
...
func (o *PluginsNetboxDNSNameserversDeleteParams) WithDefaults() *PluginsNetboxDNSNameserversDeleteParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNetboxDNSNameserversDeleteParams) WithTimeout(timeout time.Duration) *PluginsNetboxDNSNameserversDeleteParams {
...
func (o *PluginsNetboxDNSNameserversDeleteParams) WithContext(ctx context.Context) *PluginsNetboxDNSNameserversDeleteParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins netbox dns nameservers delete params
func (o *PluginsNetboxDNSNameserversDeleteParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins netbox dns nameservers delete params
func (o *PluginsNetboxDNSNameserversDeleteParams) WithHTTPClient(client *http.Client) *PluginsNetboxDNSNameserversDeleteParams {
...
func (o *PluginsNetboxDNSNameserversDeleteParams) WithID(id int64) *PluginsNetboxDNSNameserversDeleteParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the plugins netbox dns nameservers delete params
func (o *PluginsNetboxDNSNameserversDeleteParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *PluginsNetboxDNSNameserversDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
