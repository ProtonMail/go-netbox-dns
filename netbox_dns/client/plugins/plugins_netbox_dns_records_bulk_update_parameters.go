...
// NewPluginsNetboxDNSRecordsBulkUpdateParams creates a new PluginsNetboxDNSRecordsBulkUpdateParams object,
...
func NewPluginsNetboxDNSRecordsBulkUpdateParams() *PluginsNetboxDNSRecordsBulkUpdateParams {
	return &PluginsNetboxDNSRecordsBulkUpdateParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNetboxDNSRecordsBulkUpdateParamsWithTimeout creates a new PluginsNetboxDNSRecordsBulkUpdateParams object
...
// NewPluginsNetboxDNSRecordsBulkUpdateParamsWithContext creates a new PluginsNetboxDNSRecordsBulkUpdateParams object
...
// NewPluginsNetboxDNSRecordsBulkUpdateParamsWithHTTPClient creates a new PluginsNetboxDNSRecordsBulkUpdateParams object
...
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WithDefaults() *PluginsNetboxDNSRecordsBulkUpdateParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WithTimeout(timeout time.Duration) *PluginsNetboxDNSRecordsBulkUpdateParams {
...
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WithContext(ctx context.Context) *PluginsNetboxDNSRecordsBulkUpdateParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins netbox dns records bulk update params
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins netbox dns records bulk update params
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WithHTTPClient(client *http.Client) *PluginsNetboxDNSRecordsBulkUpdateParams {
...
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WithData(data *models.WritableRecord) *PluginsNetboxDNSRecordsBulkUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the plugins netbox dns records bulk update params
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) SetData(data *models.WritableRecord) {
	o.Data = data
}

// WriteToRequest writes these params to a swagger request
func (o *PluginsNetboxDNSRecordsBulkUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
