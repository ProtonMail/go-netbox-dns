...
// NewPluginsNetboxDNSViewsBulkDeleteParams creates a new PluginsNetboxDNSViewsBulkDeleteParams object,
...
func NewPluginsNetboxDNSViewsBulkDeleteParams() *PluginsNetboxDNSViewsBulkDeleteParams {
	return &PluginsNetboxDNSViewsBulkDeleteParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNetboxDNSViewsBulkDeleteParamsWithTimeout creates a new PluginsNetboxDNSViewsBulkDeleteParams object
...
// NewPluginsNetboxDNSViewsBulkDeleteParamsWithContext creates a new PluginsNetboxDNSViewsBulkDeleteParams object
...
// NewPluginsNetboxDNSViewsBulkDeleteParamsWithHTTPClient creates a new PluginsNetboxDNSViewsBulkDeleteParams object
...
func (o *PluginsNetboxDNSViewsBulkDeleteParams) WithDefaults() *PluginsNetboxDNSViewsBulkDeleteParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNetboxDNSViewsBulkDeleteParams) WithTimeout(timeout time.Duration) *PluginsNetboxDNSViewsBulkDeleteParams {
...
func (o *PluginsNetboxDNSViewsBulkDeleteParams) WithContext(ctx context.Context) *PluginsNetboxDNSViewsBulkDeleteParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins netbox dns views bulk delete params
func (o *PluginsNetboxDNSViewsBulkDeleteParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins netbox dns views bulk delete params
func (o *PluginsNetboxDNSViewsBulkDeleteParams) WithHTTPClient(client *http.Client) *PluginsNetboxDNSViewsBulkDeleteParams {
...
func (o *PluginsNetboxDNSViewsBulkDeleteParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
