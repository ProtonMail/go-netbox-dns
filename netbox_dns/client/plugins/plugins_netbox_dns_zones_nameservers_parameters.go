...
// NewPluginsNetboxDNSZonesNameserversParams creates a new PluginsNetboxDNSZonesNameserversParams object,
...
func NewPluginsNetboxDNSZonesNameserversParams() *PluginsNetboxDNSZonesNameserversParams {
	return &PluginsNetboxDNSZonesNameserversParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPluginsNetboxDNSZonesNameserversParamsWithTimeout creates a new PluginsNetboxDNSZonesNameserversParams object
...
// NewPluginsNetboxDNSZonesNameserversParamsWithContext creates a new PluginsNetboxDNSZonesNameserversParams object
...
// NewPluginsNetboxDNSZonesNameserversParamsWithHTTPClient creates a new PluginsNetboxDNSZonesNameserversParams object
...
func (o *PluginsNetboxDNSZonesNameserversParams) WithDefaults() *PluginsNetboxDNSZonesNameserversParams {
	o.SetDefaults()
	return o
}
...
func (o *PluginsNetboxDNSZonesNameserversParams) WithTimeout(timeout time.Duration) *PluginsNetboxDNSZonesNameserversParams {
...
func (o *PluginsNetboxDNSZonesNameserversParams) WithContext(ctx context.Context) *PluginsNetboxDNSZonesNameserversParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the plugins netbox dns zones nameservers params
func (o *PluginsNetboxDNSZonesNameserversParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the plugins netbox dns zones nameservers params
func (o *PluginsNetboxDNSZonesNameserversParams) WithHTTPClient(client *http.Client) *PluginsNetboxDNSZonesNameserversParams {
...
func (o *PluginsNetboxDNSZonesNameserversParams) WithID(id int64) *PluginsNetboxDNSZonesNameserversParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the plugins netbox dns zones nameservers params
func (o *PluginsNetboxDNSZonesNameserversParams) SetID(id int64) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *PluginsNetboxDNSZonesNameserversParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
