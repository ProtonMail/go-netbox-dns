...
func (m *NestedNameServer) validateName(formats strfmt.Registry) error {
...
func (m *NestedNameServer) validateURL(formats strfmt.Registry) error {
...
func (m *NestedNameServer) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedNameServer) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedNameServer) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
