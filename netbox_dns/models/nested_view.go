...
func (m *NestedView) validateURL(formats strfmt.Registry) error {
...
func (m *NestedView) contextValidateDisplay(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedView) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NestedView) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
